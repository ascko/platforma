...
class PlansTest < ApplicationSystemTestCase
  ...
  test "creating a Plan" do
    ...
    fill_in "Cena", with: @plan.Cena
    fill_in "Czastrwania", with: @plan.CzasTrwania
    fill_in "Darmowyokres", with: @plan.DarmowyOkres
    fill_in "Ilosclicencji", with: @plan.IloscLicencji
    fill_in "Nazwa", with: @plan.Nazwa
    fill_in "Idproduktu", with: @plan.idProduktu
