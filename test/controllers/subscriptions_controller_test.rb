...
class SubscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscription" do
    assert_difference('Subscription.count') do
      post subscriptions_url, params: { subscription: { idKlienta: @subscription.idKlienta, idPlanu: @subscription.idPlanu } }
    end
  ...
  test "should update subscription" do
    patch subscription_url(@subscription), params: { subscription: { idKlienta: @subscription.idKlienta, idPlanu: @subscription.idPlanu } }
